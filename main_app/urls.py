...
urlpatterns = [ 
  path('api/profiles', views.ProfileListCreate.as_view() ), #FOR REACT,
  path('api/movies/', views.MovieListCreate.as_view() ), #FOR REACT
  ...
  # path('profile/<int:profile_id>/follow/', views.toggleFollow, name='toggle_follow'),
